...
export enum EventMetadataKey {
  ...
  AGENT_CLI_USER_PROMPT_LENGTH = 13,
  ...
  AGENT_CLI_API_REQUEST_MODEL = 20,
  ...
  AGENT_CLI_API_RESPONSE_MODEL = 21,

  // Logs the status code of the response.
  AGENT_CLI_API_RESPONSE_STATUS_CODE = 22,

  // Logs the duration of the API call in milliseconds.
  AGENT_CLI_API_RESPONSE_DURATION_MS = 23,

  // Logs the error message of the API call, if any.
  AGENT_CLI_API_ERROR_MESSAGE = 24,

  // Logs the input token count of the API call.
  AGENT_CLI_API_RESPONSE_INPUT_TOKEN_COUNT = 25,

  // Logs the output token count of the API call.
  AGENT_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT = 26,

  // Logs the cached token count of the API call.
  AGENT_CLI_API_RESPONSE_CACHED_TOKEN_COUNT = 27,

  // Logs the thinking token count of the API call.
  AGENT_CLI_API_RESPONSE_THINKING_TOKEN_COUNT = 28,

  // Logs the tool use token count of the API call.
  AGENT_CLI_API_RESPONSE_TOOL_TOKEN_COUNT = 29,
  ...
  // Logs the model id of the API call.
  AGENT_CLI_API_ERROR_MODEL = 30,

  // Logs the error type.
  AGENT_CLI_API_ERROR_TYPE = 31,

  // Logs the status code of the error response.
  AGENT_CLI_API_ERROR_STATUS_CODE = 32,

  // Logs the duration of the API call in milliseconds.
  AGENT_CLI_API_ERROR_DURATION_MS = 33,
