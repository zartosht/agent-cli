...
// This variable will hold the currently configured filename for AGENT.md context files.
...
function getGlobalMemoryFilePath(): string {
  return path.join(homedir(), AGENT_CONFIG_DIR, getCurrentAgentMdFilename());
}
